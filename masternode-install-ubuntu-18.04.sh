...
COIN_TGZP='https://github.com/catscoinofficial/wallet/releases/download/v2003/catscoin-linux-daemon.zip'
COIN_BOOTSTRAP='https://github.com/catscoinofficial/cats/releases/download/v2003/Bootstrap.zip'
