...
COIN_TGZP='https://github.com/catscoinofficial/cats/releases/download/v1.0.0/Cats-Linux1804.zip'
COIN_BOOTSTRAP='https://github.com/catscoinofficial/cats/releases/download/v1.0.0/bootstrap.zip'
